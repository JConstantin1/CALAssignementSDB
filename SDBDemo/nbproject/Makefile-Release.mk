...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sdbdemo.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sdbdemo.exe: ${OBJECTFILES}
...
${OBJECTDIR}/DatabaseHandler.o: DatabaseHandler.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatabaseHandler.o DatabaseHandler.c

${OBJECTDIR}/Enrolment.o: Enrolment.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Enrolment.o Enrolment.c
